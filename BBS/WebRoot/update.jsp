				...
				<tr>
					<td align="right"><img src="./images/flat_d.gif"
						...
						href="http://www.cjsdn.net/post/view?bid=1&amp;id=200906&amp;tpg=1&amp;ppg=1&amp;sty=1&amp;age=0&amp;next=1"><img
							...
							alt="go to next topic"></a> <a href="bbsDetail.jsp?id=<%=id %>"><img
				...
				<tr class="odd">
					...
					<td valign="top" width="100%">
						...
						class="javascript" id="text200906">
							<form action="updateDeal.jsp" method="post">
								<input type="hidden" value=<%=id %> name="id"/>
								标题:&nbsp;&nbsp;<input type="text" name="title" value="<%=b.getTitle() %>"/><br><br>
								内容:&nbsp;&nbsp;	<textarea class="ckeditor" cols="80" id="editor1" name="cont" rows="10"><%=b.getCont() %></textarea>
								<br> <input type="submit" value="更新" /> <input type="reset" value="重置" />
							</form>
					</span>
				</tr>
			</tbody>
