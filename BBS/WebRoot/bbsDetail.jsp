...
<base href=".">
<%!private void getBbs(Connection conn, int id, Bbs b) {
		...
		<table border="0" cellspacing="1" cellpadding="4" width="95%">
			<tbody>
				<tr class="head">
					...
					<td><font color="#ffffff"><b> <%=b.getTitle()%>
						</b></font></td>
				</tr>
				...
				<tr class="odd">
					...
					.format(b.getDate())%>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="reply.jsp?id=<%=b.getId()%>&rootid=<%=b.getRootid()%>">回复</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<%
						if(flag) {
					 %>
					<a href="update.jsp?id=<%=b.getId()%>">更新</a>
					<%
					}
					 %>
